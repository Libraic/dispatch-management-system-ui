...
import { CalendarExpanderDropdownList } from "./CalendarExpanderDropdownList";
import { useOnClickOutside } from "#/hooks/useClickOutside";
import { GoogleIcon } from "#/ui/GoogleIcon/GoogleIcon";

type CalendarExpanderProps = {
  data: string[];
  selected: string;
...
export const CalendarExpander: React.FC<CalendarExpanderProps> = ({
  data,
  selected,
  expanderRef,
  onClick,
