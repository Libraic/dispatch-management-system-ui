...
import { getPaginationDetails } from "../../service/driver-service.ts";
import type { PaginationData } from "../../types/api/common.ts";
import { DEFAULT_SIZE } from "../../utils/api/api-query-constants.ts";
