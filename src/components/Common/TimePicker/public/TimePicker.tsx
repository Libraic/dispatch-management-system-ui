...
import type { TimePickerProps } from "../../../../types/internal/common/time-picker-types.ts";
import { SYSTEM_FONT_NORMAL } from "../../../../tailwind/tailwind-font-vars.ts";
import { InputFormLabel } from "../../InputForm/internal/InputFormLabel.tsx";
import { TimeSelector } from "../internal/TimeSelector.tsx";
    ...
    <>
      <div className="min-h-[6.5rem]">
        <div className="relative inline-block">
          <InputFormLabel label={label ?? "Time"} isFocused={open} />
          <div
            ref={inputRef}
            role="button"
            tabIndex={0}
