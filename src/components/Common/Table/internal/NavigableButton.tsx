...
export const NavigableButton: React.FC<{
  ...
  return (
    <div
      ...
      className={`flex flex-row items-center font-lato font-normal px-3 py-1 rounded-[0.25rem] hover:cursor-pointer ${BACKGROUND_NORMAL_COLOR} ${HOVER_BACKGROUND_SOLID_COLOR} text-white text-[0.85rem] hover:border-none gap-x-[0.5rem]`}
    >
