  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen gap-y-[1rem]">
      ...
      <div className="flex flex-col items-center text-white">
        <p className="font-roboto font-bold text-[2rem]">
          Dispatch Management System
        </p>
        <p className="font-roboto font-thin text-[1.25rem]">
          Powered by Kovin Group
        </p>
      </div>
      <div className="flex flex-row gap-x-[2rem] pt-5">
        <div
          className="flex items-center justify-center font-roboto font-normal text-[0.9rem] text-black border-1 border-white bg-white rounded-[1.2rem] px-2 py-1 hover:cursor-pointer w-[8.75rem] h-[2.7rem]"
