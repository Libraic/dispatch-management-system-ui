          ...
          <tbody className="font-roboto font-light bg-[#f5f7fc]">
            {kpiModels.map((kpiModel) => (
              <tr key={kpiModel.uuid}>
                <td className="w-[12rem] p-3 sticky left-0 z-100 outline-2 -outline-offset-1 outline-pale-blue bg-[#f5f7fc]">
                ...
                {kpiModel.kpisData.map((kpiDataModel, kpiIndex) => (
                  <td
                    ...
                    className="w-[12rem] pl-1 text-left border-2 border-pale-blue"
                  >
                    <div className={`${gridTemplate} text-center`}>
                      {kpiDataModel.kpis.map((kpiValue, dIndex) => (
                        <div
                          key={dIndex}
                          className="truncate border-l-2 first:border-l-0 border-pale-blue"
                        >
