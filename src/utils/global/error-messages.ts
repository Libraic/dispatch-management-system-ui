...
// Truck
export const TRUCK_NUMBER_IS_MANDATORY = "The truck number cannot be empty.";
export const VIN_NUMBER_IS_MANDATORY = "The VIN number cannot be empty.";
export const TRUCK_YEAR_INVALID = "The truck year is not valid.";
export const TRUCK_WEIGHT_INVALID = "The truck weight is not valid.";
