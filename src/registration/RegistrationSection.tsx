...
export const RegistrationSection: React.FC<{
  ...
  return (
    <div
      className="flex justify-between items-center hover:bg-[#e7e8ee] hover:cursor-pointer rounded-xl h-6 w-40 transition-colors ease-in duration-200 pl-2 pr-2"
      onClick={activateSection}
    >
      <p className="text-[0.7rem] font-inter-300">{sectionTitle}</p>
      <img
